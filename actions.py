...
zomato_config={ "user_key":"b3c400b057dfdf166ded1203e40c6fa4"}
...
class ActionSendEmail(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		if len(email.split("|")) == 2:
			email = email.split("|")[1]
#        dispatcher.utter_message(email+'2')
		import smtplib 
		s = smtplib.SMTP('smtp.gmail.com', 587) 
		s.starttls() 
		s.login("sravya.chatbot@gmail.com", "chatbot_1234")
		message = "The details of all the restaurants you inquried \n \n"
		global result_of_last_query
		message = message + result_of_last_query
		try:
			s.sendmail("sravya.chatbot@gmail.com", str(email), message)
			s.quit()
		except:
			dispatcher.utter_message(email)
